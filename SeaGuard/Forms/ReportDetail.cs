...
namespace SeaGuard_Database.Forms
{
    public partial class ReportDetail : Form
    {
        ...
        {
            _data = data;
            LoadToFields(); // Memperbaiki error CS0103
        }
        ...
        // --- Logika Memuat Data ke Field (Memperbaiki error CS0103) ---
        ...
        {
            this.Close(); // Kembali ke ReportsList
        }
        ...
        // --- Logika Pilih Foto untuk Update ---
        ...
        // --- HELPER METHOD: Resolve Path Foto (Memperbaiki error CS0103) ---
        ...
        // Event bawaan lainnya (Biarkan kosong)
